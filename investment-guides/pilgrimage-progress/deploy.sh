...
HERE="/Users/mikethezier/Documents/GitHub/thezier.github.io/investment-guides/pilgrimage-progress"
TARGET="/Users/mikethezier/Documents/GitHub/pilgrimage-progress"

echo "==> building index.html from build/"
python3 "$HERE/build/build.py"

echo "==> progress.pilgrimage.media"
